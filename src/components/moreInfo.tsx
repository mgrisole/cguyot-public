...
export const MoreInfo: Component<{
    ...
    <div>
      <div class={"flex mt-8 p-3 justify-end"}>
        <button
          ...
          class={
            "flex bg-independence text-baby-powder items-center gap-2 px-5 py-3 border rounded-2xl border-independence shadow-md"
          }
        >
          <span class="text-xl">
            {toggled() ? <BiRegularMinus /> : <BiRegularPlus />}
          </span>
